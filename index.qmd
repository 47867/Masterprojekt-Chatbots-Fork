...
<!--??? anpasen welcher appendix / online materlialien  -->

<!--??? desing vom graphen anpassen  -->
...
ist halt irgendwie fehleranfällig ne -> vielleicht noch totale abweichung für so allgemeine feleinschätzungen das plaktivere maß--> Am deutlichsten kontrastieren Cluster zwei und drei.
...
### Vergleich mit Kontextvariablen {.unnumbered}
...
Die Grafiken werden aus den ggplot-Objekten des Analyseskripts gesetzt; Titel und Untertitel der Objekte sind ausgeblendet, da diese Information in der Abbildungsunterschrift steht.
