...
Ziel dieser Arbeit ist es, zu untersuchen, inwiefern sich Selbstauskünfte Studierender zur studienbezogenen Nutzung generativer KI-Chatbots von ihrem in gespendeten Chatverläufen beobachtbaren Nutzungsverhalten unterscheiden. Zur Beantwortung wurden in einer Online-Befragung Selbstauskünfte 21 Studierender zu Interaktionsstil, kritischem Prüfen von Chatbot-Antworten und studienbezogener Informationsnutzung erhoben und mit freiwillig gespendeten, mittels eines Large-Language-Modells klassifizierten Chatverläufen abgeglichen. Während Angaben zu Schreib- und Lernaufgaben weitgehend zutreffend berichtet werden, zeigen sich deutliche Abweichungen bei Informationssuche sowie praktischer und technischer Unterstützung, beim Umgangston und insbesondere beim kritischen Prüfen von Antworten, das im Survey deutlich häufiger berichtet als in den Logs sichtbar wird. Eine explorative PAM-Clusteranalyse ordnet die Stichprobe vier über drei Robustheitschecks hinweg stabilen Clustern mit unterschiedlichen Diskrepanzmustern zu, die sich weniger im Ausmaß als in der Richtung ihrer Abweichungen unterscheiden. Ergänzende, für die geringe Stichprobengröße explorative Korrelations- und Gruppenvergleiche zeigen keine statistisch robusten, aber deskriptiv erkennbare Zusammenhänge der Diskrepanzen mit Alter, KI-Erfahrung und sozialer Erwünschtheit sowie unterschiedliche Kontextprofile der Cluster. Diese Befunde legen nahe, dass Selbstauskünfte zur KI-Nutzung konstrukt- und gruppenspezifisch verzerrt sind und nicht gleichmäßig korrigiert werden können. Für künftige Forschung wird empfohlen, Selbstauskünfte systematisch durch Verhaltensdaten zu ergänzen und größere, breiter zusammengesetzte Stichproben sowie weitere KI-Anwendungen einzubeziehen.
...
Um den hierarchischen Charakter zu verdeutlichen, wurden die Forschungsfragen F2 bis F6 als untergeordnete Forschungsfragen der übergeordneten Forschungsfrage F1 zusammengefasst. Damit ändern sich nur die Bezeichnungen der Forschungsfragen von F2 bis F6 zu F1a bis F1e.

In der Präregistrierung wurde angegeben, dass die Anzahl der Cluster für die Silhouette-Methode auf sechs beschränkt wird. Diese wurde auf 10 ausgeweitet und eine Mindestgröße für die Cluster definiert. So können zu kleine Cluster verhindert werden, für die die Beschränkung von k ursprünglich gedacht war.
