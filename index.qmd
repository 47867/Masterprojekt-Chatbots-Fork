...
Surveyangaben können durch verschiedene Biases beeinflusst werden. Diese können bewusst oder unbewusst erfolgen.
...
Zuletzt kann es zudem vorkommen, dass Personen eine verzerrte Einschätzung der eigenen Person haben, die sie im Fragebogen so angeben wollen.
...
Zunächst wurde von den Respondenten eine informierte Einwilligung erbeten.
Dort konnten sie angeben, dass sie die sowohl Studieninformationen und Datenschutzinformationen gelesen haben, mit der Studie und der Erhebung und Verarbeitung ihrer Daten einverstanden sind und dass sie mindestens 18 Jahre alt sind.
...
Im Hauptteil der Studie wurden drei zentralen Konzepte erfragt, die sich auch aus den Chatlogs ermitteln lassen.
Zum einen wurden Respondenten gefragt, wie ihre typische Interaktion mit ChatGPT aussieht, sprich wie freundlich bis unfreundlich sie Ihren eigenen Umgang einschätzen.
...
Als letztes zentrales Konzept wurden Respondenten gebeten, ihr typisches Nutzungsverhalten auf fünf Aufgabenbereiche zu verteilen, indem sie insgesamt zehn Punkte vergeben.
...
Im fünften Block wurde nach einem freiwilligen Upload der fünf letzten studienbezogenen Chatlogs gefragt.
Dafür mussten Respondenten erneut eine informierte Einwilligung abgeben.
Für das Hochladen sollten Respondenten zunächst einen Prompt direkt in den jeweiligen Chat als Nachricht zu schreiben, um von ChatGPT den gesamten Chatverlauf als JSON-Syntax in einer Antwortnachricht zu erhalten. ChatGPT gibt jedoch nicht zuverlässig den Chatverlauf als JSON aus. Deshalb wurde den Respondenten die Möglichkeit gegeben, die Chatlogs alternativ als HTML-Datei hochzuladen.

Im sechsten Teil wurde gefragt, welche technischen Probleme aufgetreten sind.
Als nächstes sollten die Respondenten jeweils angeben, inwiefern sie zustimmen, dass ihre Angaben ihre echte Nutzung widerspiegeln, sich ihre Nutzung stark nach Aufgabe unterscheidet und ihre hochgeladenen Chatlogs ihre Nutzung gut widerspiegeln.

Nach den Angaben zu den zentralen Konzepten wurden soziodemographischen Variablen abgefragt, die für die Analyse relevant sind. Dies umfasst Variablen, die für Respondenten üblicherweise wenig Konzentration erfordern und deshalb am Ende des Fragebogens platziert wurden.
Zu den soziodemografischen Variablen gehören Alter, Geschlecht nach @ZA10100, Studienfach, der angestrebte Studienabschluss und soziale Erwünschtheit nach @kemper2014.

<!-- TODO: Hier noch Operationalisierung beschreiben -->

Da das Ziel der Studie der Vergleich zweier Datenquellen ist, werden kaum klassischen Skalen gebildet. Jediglich die Itembatterie zur sozialen Erwünschtheit wird als Index gebildet. Dafür werden Items, die in die gleiche Richtung gehen, gemittelt und Items, die in die entgegengesetzte Richtung gehen, invertiert und anschließend gemittelt.
...
Zu Beginn der Feldphase wurde erkennbar, dass die Texteingaben im Fraebogen über ein internes Limit verfügen, was nicht direkt in SoSci Survey erkennbar war.
Durch dieses Limit wurden zu lange Texteingaben, die im Survey abgeschickt wurden anschließend aus dem Datensatz entfernt.
Die Respondenten bekamen daraufhin den Hinweis, welcher Fehler aufgetreten war und dazu angehalten, sich per Mail an die anhabende Person des SoSci Survey Projekts zu wenden und die gelöschten Eingaben so zu senden.
Es kann davon ausgegangen werden, dass diese Fehleranzeige zu einer Irritation geführt hat.
Später erhielten wir von SoSci Survey oder von den Respondenten selbst die gelöschten Eingaben per Mail zugesandt, wodurch Fälle manuell vervollständigt werden konnten und so keine Daten verlorgen gingen.
Da diese Fälle erst nach Beginn der Haupterhebung aufgetreten sind und deshalb nicht antizipiert werden konnten, sind diese Mails nicht von der Datenschutzerklärung abgedeckt.
Alle E-Mails, die Chatverläufe enthalten, wurden nach der Datenerhebung gelöscht. Respondenten, die ihre Chatverläufe per E-Mail geschickt hatten, wurden dazu aufgefordert, die jeweilige E-Mail zu löschen.
