...
source(here::here("Python_code/data_prep.R"))
...
F5: Welche typischen personenbezogenen Diskrepanzmuster lassen sich über die untersuchten Nutzungsdimensionen hinweg explorativ identifizieren?
...
: Operationalisierung der zentralen Konstrukte
...
Nach Bereinigung der Daten teilt sich die Stichprobe in 21 Männer (57,14 %) und 16 Frauen (42,86 %) auf. Hinsichtlich des angestrebten Abschlusses bildeten Masterstudierende mit 14 Personen (66,67 %) die größte Gruppe. Vier Personen (19,05 %) studierten im Bachelor und drei Personen (14,29 %) promovierten. Auch die Studienrichtungen waren annähernd gleich verteilt: Elf Personen (52,38 %) studierten ein sozialwissenschaftliches Fach, während zehn Personen (47,62 %) einer anderen Studienrichtung angehörten. Die Fragebogendauer lag im Mittel bei knapp 13 Minuten. Das kürzeste Interview dauerte dabei knapp 3 Minuten, während das längste über 27 Minuten andauerte. 
...
Die präregistrierte Forschungsfrage (F5: Wie gut eignet sich die LLM-basierte Klassifikation, um Dimensionen der Informationsnutzung in Chatlogs systematisch zu erfassen und mit Surveyangaben zu vergleichen?) wurde im Methodenteil abgehandelt und deshalb nicht als eigene Forschungsfrage mehr aufgenommen. Stattdessen lautet die Forschungsfrage nun so: *Welche typischen personenbezogenen Diskrepanzmuster lassen sich über die untersuchten Nutzungsdimensionen hinweg explorativ identifizieren?* und fokussiert sich stärker auf die ebenfalls präregistrierte Clusteranalyse.
...
Müssen noch einen erweiterten anhang für die daten sowie code sowie llm-paper machen
...
## Online-Anhang {#sec-online-anhang .unnumbered}
Die in der Analyse verwendeten Daten finden Sie unter
[GitHub: data/processed](https://github.com/lpkiemes/Masterprojekt-Chatbots/tree/main/data/processed).

Der gesamte Code für dieses Projekt ist unter
[GitHub: Masterprojekt-Chatbots](https://github.com/lpkiemes/Masterprojekt-Chatbots)
abrufbar.
