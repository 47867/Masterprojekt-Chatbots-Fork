...
## Forschungslücke {#sec-forschungslücke}
...
Zunächst wurde von den Respondenten nach den Studieninformationen und nach den Datenschutzhinweisen eine informierte Einwilligung erbeten.
...
Da ChatGPT die JSON-Ausgabe nicht immer korrekt erstellt, wurde den Respondenten die Möglichkeit gegeben, die Chatlogs alternativ als HTML-Datei hochzuladen.
...
Stattdessen wurde für die zentralen Konstrukte (Sentiment, kritisches Prüfen und Informationsnutzung) Diskrepanzmaße zwischen den Surveyangaben und den aus den Chatlog extrahierten Informationen berechnet, die die Grundlage für die Analyse bilden.
...
Da diese Fälle erst nach Beginn der Haupterhebung aufgetreten sind, sind diese Mails nicht von der Datenschutzerklärung abgedeckt.
Die erhaltenen E-Mails wurden nach der Datenerhebung gelöscht und Respondenten wurden per E-Mail dazu aufgefordert, die jeweilige E-Mail zu löschen.
